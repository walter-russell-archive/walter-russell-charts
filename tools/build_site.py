...
SYNC = [
    ...
    ("data/claims_notes.md", "data/claims_notes.md", True),
    ("data/plate_audit.md", "data/plate_audit.md", True),
    ("data/comparison.tsv", "data/comparison.tsv", True),
    ("essay/comparison.md", "essay/comparison.md", True),
    ...
    ("data/restoration_study/scoring_protocol.json",
     "data/restoration_study/scoring_protocol.json", True),
